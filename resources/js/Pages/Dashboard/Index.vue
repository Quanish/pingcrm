                    ...
                    <div class="border rounded-2xl px-5 py-4 flex flex-col hover:border-indigo-300 hover:shadow-sm">
                        <div class="flex flex-row justify-between mb-3">
                            <div class="flex flex-row">
                                <person-card :id="event.auditor.id" :src="'/storage/' + event.auditor.photo_path" :fullname="event.auditor.last_name + ' ' + event.auditor.first_name" :job="event.auditor.position.name"></person-card>
                            </div>
