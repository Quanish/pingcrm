    	...
    	<table class="w-full whitespace-nowrap">
	        ...
	        <tr class="hover:bg-gray-100 focus-within:bg-gray-100 mb-3">
	        	<td class=" flex justify-start items-center">
	       	   		<div>
		       	   		<p class="text-sm">Название отчета</p>
		       	   		<p class="text-2xs">Краткое описание отчета/ какие показатели </p>
		       	   	</div>
               </td>  
               <td>
               		<p class="text-center">10 / 05 / 2021</p>
               </td> 
	       	   <td>
               ...
               <td class="text-center">
               		<p class="text-sm text-center">Комментарии</p>
               </td> 
               <td class="">
