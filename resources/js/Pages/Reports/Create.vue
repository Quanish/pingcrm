<template>
  <div class="py-6 px-6 bg-white rounded-lg overflow-y-auto overflow-x-hidden h-full">
    ...
    <div class="space-y-4">
      <div class="flex h-6"><p class="w-1/6">Название<span class="text-red-400">*</span></p><input type="text" class="w-4/6 border-b-2 w-full pb-1"><p class="mr-3">Категория</p>
      ...
      <div class="flex"><p class="w-1/6">Доступ<span class="text-red-400">*</span></p>
