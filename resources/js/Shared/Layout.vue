      ...
      <div class="md:h-screen md:flex md:flex-col">
        <div class="menu_bar h-100 md:flex md:flex-shrink-0">
          ...
          <div class="w-full  md:py-0 md:px-0 text-sm md:text-md flex justify-start items-center">
            <div class="mt-1">
              <div class="relative">  
                <input class="search w-64 rounded-full pl-10"  />
                  <div class="absolute inset-y-0 left-1">
                   <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="-4 -2 24 24" class="w-4 h-4"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                  </div>
              </div>
            </div>
              ...
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('tasks')">
                  ...
                  <div :class="isUrl('tasks') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Задачи</div>
                </inertia-link>
              </div>
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('groups')">
                 
                  <div :class="isUrl('groups') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Группы</div>
                </inertia-link>
              </div>
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('organizations')">
                 
                  <div :class="isUrl('organizations') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Клиенты</div>
                </inertia-link>
              </div>
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('groups')">
                 
                  <div :class="isUrl('groups') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Счета</div>
                </inertia-link>
              </div>
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('agreements')">
                 
                  <div :class="isUrl('agreements') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Сделки</div>
                </inertia-link>
              </div>
              <div class="ml-8">
            ...
            <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('calendar')">
                  ...
                  <div :class="isUrl('calendar') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Календарь</div>
                </inertia-link>
              </div>
              <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('calendar')">
                 
                  <div :class="isUrl('calendar') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Аналитика</div>
                </inertia-link>
              </div>
               <div class="ml-8">
                <inertia-link class="flex items-center group py-3" :href="route('mail')">
                 
                  <div :class="isUrl('mail') ? 'text-white' : 'text-white group-hover:text-white font-bold'">Почта</div>
                </inertia-link>
              </div>
            </div>
            ...
            <dropdown class="mt-1 w-48" placement="bottom-end">
                <div class="text-gray-700 group-hover:text-indigo-600 focus:text-indigo-600 mr-10 whitespace-nowrap">
                  <img src="img/default-user.png" class="h-12 w-12" />
                </div>
