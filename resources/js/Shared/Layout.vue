          ...
          <div class="w-full  md:py-0 md:px-0 text-sm md:text-md flex justify-start items-center">
            ...
            <dropdown class="mt-1 w-48" placement="bottom-end">
                <div class="text-gray-700 group-hover:text-indigo-600 focus:text-indigo-600 mr-10 whitespace-nowrap">
                  <img :src="$page.props.auth.user.photo_path" class="h-12 w-12" />
                </div>
