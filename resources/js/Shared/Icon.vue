<template>
  ...
  <svg v-else-if="name === 'users'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M7 8a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0 1c2.15 0 4.2.4 6.1 1.09L12 16h-1.25L10 20H4l-.75-4H2L.9 10.09A17.93 17.93 0 0 1 7 9zm8.31.17c1.32.18 2.59.48 3.8.92L18 16h-1.25L16 20h-3.96l.37-2h1.25l1.65-8.83zM13 0a4 4 0 1 1-1.33 7.76 5.96 5.96 0 0 0 0-7.52C12.1.1 12.53 0 13 0z" /></svg>
   ...
   <svg v-else-if="name === 'file'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0,2.99508929 C0,1.8932319 0.898212381,1 1.99079514,1 L18.0092049,1 C19.1086907,1 20,1.8926228 20,2.99508929 L20,17.0049107 C20,18.1067681 19.1017876,19 18.0092049,19 L1.99079514,19 C0.891309342,19 0,18.1073772 0,17.0049107 L0,2.99508929 Z M2,5 L18,5 L18,17 L2,17 L2,5 Z" id="Combined-Shape"></path>
  </svg>

  <svg v-else-if="name === 'checkmark'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
              <g id="icon-shape">
  ...
  <svg v-else-if="name === 'case'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      <g id="icon-shape">
        <path d="M6,5 L1.99079514,5 C0.898212381,5 0,5.89805351 0,7.00585866 L0,16.9941413 C0,18.1029399 0.891309342,19 1.99079514,19 L3,19 L3,5 L4,5 L4,19 L16,19 L16,5 L17,5 L17,19 L18.0092049,19 C19.1017876,19 20,18.1019465 20,16.9941413 L20,7.00585866 C20,5.89706013 19.1086907,5 18.0092049,5 L14,5 L14,4 C14,2.88772964 13.1054196,2 12.0018986,2 L7.99810135,2 C6.88670635,2 6,2.8954305 6,4 L6,5 Z M8,4 L12,4 L12,5 L8,5 L8,4 Z" id="Combined-Shape"></path>            
      </g>
  </svg>

  <svg v-else-if="name === 'calendar'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
    <g id="icon-shape">
  ...
  <svg v-else-if="name === 'print'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
    <g id="icon-shape">
